...
pc <- pc |> mutate(note = case_when(
  ...
  item %in% owed_items ~ "Generated from publication/manuscript/title-page.yml; OUTSTANDING until that field is filled.",
  item %in% prov_items ~ paste("Stated on the title page, generated from publication/manuscript/title-page.yml.",
                               "Data are offered on request; no repository deposit has been made."),
  .default = "Stated on the title page, generated from publication/manuscript/title-page.yml."))
