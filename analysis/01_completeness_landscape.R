...
save_df_tbl(tab, "T_completeness_landscape",
            ...
            footer = sprintf(paste0("Percentage of applicable analyzable studies (n = %s) reporting each covariate ",
              ...
              "the extraction's own judgement and were not validated, so a row whose applicable N is small should ",
              "be read as indicative. CYP3A5 pharmacogenomics is uninformative on this point: no study its trigger ",
              "selects reports expressor status, which suggests the trigger admits studies that merely mention ",
              "pharmacogenomics. * minimum ",
