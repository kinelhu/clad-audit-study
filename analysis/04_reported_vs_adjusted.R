...
write_legend("F_confounding", paste0(
  ...
  "and reported-but-not-adjusted percentages are printed in black beside their segments; not-reported segments ",
  "are unlabelled. Minimum-set covariates are in bold blue. (B) Number of the five ",
